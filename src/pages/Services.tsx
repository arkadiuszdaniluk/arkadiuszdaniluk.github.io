  ...
  const services = [
    {
      ...
      features: t('services.backend_dev_features', { returnObjects: true }),
    },
    {
      icon: '📱',
      title: t('services.mobile_dev'),
      description: t('services.mobile_dev_desc'),
      features: t('services.mobile_dev_features', { returnObjects: true }),
    },
    {
      icon: '💡',
      title: t('services.consulting'),
      description: t('services.consulting_desc'),
      features: t('services.consulting_features', { returnObjects: true }),
    },
  ];
      ...
      <section className="section-padding bg-light">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {t('services.process_titles', { returnObjects: true }).map((title, i) => ({
              step: i + 1,
              title,
              desc: t('services.process_descs', { returnObjects: true })[i]
            })).map((process, i) => (
